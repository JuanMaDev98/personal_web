...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'gradient-brand': 'linear-gradient(135deg, #00FFA3 0%, #7B61FF 100%)',
        'gradient-brand-soft':
          'linear-gradient(135deg, rgba(0,255,163,0.1) 0%, rgba(123,97,255,0.1) 100%)',
        'gradient-sunset':
          'linear-gradient(135deg, #FF6B6B 0%, #FFD93D 50%, #00FFA3 100%)',
        'noise':
